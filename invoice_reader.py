...
"""
    ...
    text_response = response.choices[0].message.content        # Extract the text response from the API
    match = re.search(r"\{.*\}", text_response, re.DOTALL)     # Use a regular expression to find the JSON object
    if match:
        return json.loads(match.group(0))                      # Parse the JSON object and return it
    else:
...
if __name__ == "__main__":
    image_url = "https://s3.amazonaws.com/thumbnails.venngage.com/template/f817aebd-2d8e-42cf-8c9f-80a234f077ea.png"
